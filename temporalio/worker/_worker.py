...
from ._payloads import _WorkerPayloadLimits
...
class Worker:
    ...
    async def _run(self):
        ...
        payload_limits = _WorkerPayloadLimits(
            upload_size_error_limit=namespace_info.limits.blob_size_limit_error
            if namespace_info and namespace_info.HasField("limits")
            else None
        )
