...
if TYPE_CHECKING:
    from temporalio.extstore import Options, _ExternalStorageMiddleware
...
class DefaultFailureConverter(FailureConverter):
    ...
    def to_failure(
        ...
        """See base class."""
        from temporalio.extstore import PayloadNotFoundError  # noqa: PLC0415
...
class DataConverter(WithSerializationContext):
    ...
    external_storage: Options | None = None
