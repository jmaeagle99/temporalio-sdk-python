...
`temporalio.contrib.aws.s3driver.S3Driver` stores and retrieves payloads in Amazon S3. Full documentation and examples are in [temporalio/contrib/aws/README.md](temporalio/contrib/aws/README.md).
...
* `Driver.type()` should be consistent across all instances of the same driver class, and ideally matches the equivalent implementation in other Temporal SDK languages.
